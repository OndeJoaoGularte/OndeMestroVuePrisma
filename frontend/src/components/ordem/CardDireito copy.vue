                            ...
                            <div v-else class="d-flex flex-column h-100">
                                ...
                                <div class="overflow-y-auto flex-grow-1">
                                    <v-list lines="two" density="compact" class="pt-0">
                                        <v-list-item v-for="ritual in rituaisFiltrados" :key="ritual.instanceId"
                                            :title="ritual.nome" :subtitle="ritual.descricao">
                                            <template v-slot:prepend>
                                                <v-avatar size="32" :color="getRitualColor(ritual.elemento)"
