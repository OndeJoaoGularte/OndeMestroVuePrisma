<template>
  ...
  >
    <v-card>
      <v-card-title class="bg-red-darken-4 text-white d-flex align-center">
        ...
        <v-row dense align="center" class="mb-2">
          ...
          <v-col cols="2" class="d-flex justify-center">
            <v-btn 
              ...
              :disabled="!localTipo || localValor <= 0"
            ></v-btn>
          </v-col>
        </v-row>
          ...
          <v-list density="compact" class="bg-transparent">
            ...
            >
              ...
              <v-list-item-title class="font-weight-bold d-flex justify-space-between align-center">
                <span>{{ res.tipo }}</span>
                <v-chip size="small" :color="getDanoColor(res.tipo)" variant="flat" class="font-weight-black">
                  {{ res.valor }}
                </v-chip>
              </v-list-item-title>
