        ...
        <v-card class="d-flex flex-column">
            ...
            <v-card-text class="pa-0 d-flex flex-column" style="height: 65vh;">
                ...
                <div style="flex: 0 0 auto; z-index: 2;" class="bg-surface border-b">
                    ...
                    <div class="pa-3">
                        <v-text-field v-model="search" placeholder="Pesquisar ritual..."
                        ...
                        <v-row dense>
                            <v-col>
                                <v-btn @click="showRitualElementoFilters = !showRitualElementoFilters"
                                    ...
                                    :color="filtroElemento.length > 0 ? 'primary' : undefined">
                                    Elemento
                                </v-btn>
                            </v-col>
                            <v-col>
                                <v-btn @click="showRitualCirculoFilters = !showRitualCirculoFilters"
                                    ...
                                    variant="tonal" block size="small"
                                    :color="filtroCirculo.length > 0 ? 'primary' : undefined">
                                    Círculo
                                </v-btn>
                            </v-col>
                        </v-row>
                        ...
                        <v-expand-transition>
                            <div v-if="showRitualElementoFilters" class="mt-2">
                                <v-chip-group v-model="filtroElemento" selected-class="ring-active" multiple column>
                                    <v-chip value="Sangue" filter size="small" color="red-darken-2"
                                        variant="tonal">Sangue</v-chip>
                                    <v-chip value="Morte" filter size="small" color="grey-darken-3"
                                        variant="tonal">Morte</v-chip>
                                    <v-chip value="Conhecimento" filter size="small" color="yellow-darken-3"
                                        variant="tonal">Conhecimento</v-chip>
                                    <v-chip value="Energia" filter size="small" color="purple-darken-2"
                    ...
                    <v-expansion-panels variant="accordion">
                        <v-expansion-panel v-for="ritual in listaExibida" :key="ritual.id">
                                ...
                                <v-row no-gutters align="center">
                                    <v-col cols="auto" class="mr-3">
                                        <v-avatar size="32" :color="getElementoColor(ritual.elemento)" variant="flat">
                                            <span class="text-white font-weight-bold text-caption">{{ ritual.circulo
                                                }}º</span>
                                        </v-avatar>
                                    </v-col>
                            ...
                            <v-expansion-panel-text>
                                <div
                                    class="d-flex justify-space-between text-caption mb-2 text-medium-emphasis border-b pb-1">
                                ...
                                <v-row dense justify="end">
                                    <v-col cols="auto">
                                        <v-btn variant="flat" color="primary" size="small" @click="adicionar(ritual)">
                                            Adicionar à Ficha
                                        </v-btn>
                                    </v-col>
                                </v-row>
